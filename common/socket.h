...
# define SOCK_ERR_AGAIN WSAEWOULDBLOCK
...
# define SOCK_ERR_CONNABORTED WSAECONNABORTED
# define SOCK_ERR_CONNRESET WSAECONNRESET
# define SOCK_ERR_NOTCONN WSAENOTCONN
# define SOCK_ERR_TIMEDOUT WSAETIMEDOUT
# define SOCK_ERR_CONNREFUSED WSAECONNREFUSED
# define SOCK_ERR_ADDRINUSE WSAEADDRINUSE
# define SOCK_ERR_ADDRNOTAVAIL WSAEADDRNOTAVAIL
# define SOCK_ERR_NETDOWN WSAENETDOWN
# define SOCK_ERR_NETUNREACH WSAENETUNREACH
# define SOCK_ERR_NETRESET WSAENETRESET
# define SOCK_ERR_HOSTUNREACH WSAEHOSTUNREACH
# define SOCK_ERR_NOBUFS WSAENOBUFS
# define SOCK_ERR_MSGSIZE WSAEMSGSIZE
# define SOCK_ERR_NOTSUP WSAEOPNOTSUPP
# define SOCK_ERR_AFNOSUPPORT WSAEAFNOSUPPORT
# define SOCK_ERR_PROTONOSUPPORT WSAEPROTONOSUPPORT
# define SOCK_ERR_NOPROTOOPT WSAENOPROTOOPT

# define SOCK_IS_AGAIN( e ) ( ( e ) == WSAEWOULDBLOCK )
...
# define SOCK_ERR_CONNABORTED ECONNABORTED
# define SOCK_ERR_CONNRESET ECONNRESET
# define SOCK_ERR_NOTCONN ENOTCONN
# define SOCK_ERR_TIMEDOUT ETIMEDOUT
# define SOCK_ERR_CONNREFUSED ECONNREFUSED
# define SOCK_ERR_ADDRINUSE EADDRINUSE
# define SOCK_ERR_ADDRNOTAVAIL EADDRNOTAVAIL
# define SOCK_ERR_NETDOWN ENETDOWN
# define SOCK_ERR_NETUNREACH ENETUNREACH
# define SOCK_ERR_NETRESET ENETRESET
# define SOCK_ERR_HOSTUNREACH EHOSTUNREACH
# define SOCK_ERR_NOBUFS ENOBUFS
# define SOCK_ERR_MSGSIZE EMSGSIZE
# define SOCK_ERR_NOTSUP EOPNOTSUPP
# define SOCK_ERR_AFNOSUPPORT EAFNOSUPPORT
# define SOCK_ERR_PROTONOSUPPORT EPROTONOSUPPORT
# define SOCK_ERR_NOPROTOOPT ENOPROTOOPT

# define SOCK_IS_AGAIN( e ) ( ( e ) == EAGAIN || ( e ) == EWOULDBLOCK )
